...
function kb_sourmash(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_sourmash = function (SourmashParams, _callback, _errorCallback) {
        if (typeof SourmashParams === 'function')
            throw 'Argument SourmashParams can not be a function';
        ...
        return json_call_ajax(_url, "kb_sourmash.run_sourmash",
            [SourmashParams], 1, _callback, _errorCallback);
    };
