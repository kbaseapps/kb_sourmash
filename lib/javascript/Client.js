...
function kb_sourmash(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_sourmash_compare = function (SourmashCompareParams, _callback, _errorCallback) {
        if (typeof SourmashCompareParams === 'function')
            throw 'Argument SourmashCompareParams can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "kb_sourmash.run_sourmash_compare",
            [SourmashCompareParams], 1, _callback, _errorCallback);
    };
